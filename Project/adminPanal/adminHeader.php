    ...
    <div id="navBarConatin"class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Edit Division Data<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        
                        <li><a href="psave.php">Add new Principal</a></li>
                        <li><a href="check.php">Update/Remove Schools</a></li>
                        <li><a href="checkPrincipal.php">Update/Remove Principals</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="directorMsg.php">Update Director Message</a></li>
                        <li role="separator" class="divider"></li>
                ...
                <li><a href="documentAdmin.php">Documents</a></li>
                <li><a href="gallery.php">Gallery</a></li>
                <li><a href="selectCategory.php">Add New User</a></li>
