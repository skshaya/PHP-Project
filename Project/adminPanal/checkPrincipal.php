...
<div class="panel bg-primary" style="width:15cm;margin-top:100px;margin-left: 450px ;margin-right: 200px;  border-style: solid;border-color: blue; color:black;">
        <div class=" panel-heading text-center bg-primary" ><strong>Change Prinipal dateils </strong></div>

     <form class="form-horizontal" method="post" action="checkprinicipal1.php" name="Cjd"  >
      <div class="panel-body bg-info">
          <div class="form-group" >
                <label class="control-label col-sm-3" for="Scode">  Principal ID:</label>
                <div class="col-sm-9">
