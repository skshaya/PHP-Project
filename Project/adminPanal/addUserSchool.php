...
<html lang="en">
  ...
  <div class="container" style="margin-top: 25px;margin-left: 150px;">
    <h1>Register School User</h1>
  </div>
  
  <div class="container custom">
  <form method="post" action="addUserSchool.php">
  
  		<div class="form-group">
    		<label>School Id</label>
        	<input type="text" class="form-control" name = "schId" placeholder="School ID"
            data-validation="required">
    	</div>
  		<div class="form-group">
    		<label>School Name</label>
        	<input type="text" class="form-control" name = "schName" placeholder="School Name"
            data-validation="required">
    	</div>
    
    	<div class="form-group">
    		<label>Address</label>
        	<textarea class="form-control" name = "schAddress" placeholder="Type Your School Address Here"
         ...
         <div class="form-group">
        	...
        	<input type="text" class="form-control" name = "count"
             data-validation="number"  placeholder="Student Count in School">
    	</div>
        
         <div class="form-group">
    		<label>Principal Id</label>
        	<input type="text" class="form-control" name = "prinId" placeholder="Type principal's id Here"
            data-validation="required">
         ...
         <div class="form-group">
        	...
        	<input type="text" class="form-control" name = "prinName" placeholder="Type Principal's Name Here"
            data-validation="required">
    	</div>
  ...
  <?php
		...
		while($row=mysqli_fetch_array($queryNew)){
					$lastid = $row['max(id)'];		
					$query2 = "INSERT INTO school (id,schoolId, schoolName, Address, studentCount, principalId, principalName, telNo, email) VALUES('".$lastid."','".$schId."','".$schName."','".$Address."','".$stCount."','".$prinId."','".$prinName."','".$telephone."','".$email."')";
