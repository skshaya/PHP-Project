...
$userid = $_SESSION['userid'];
	...
	$sql ="SELECT * FROM zonelofficestaff WHERE id='".$userid."'";
...
<?php
  ...
  if(isset($_POST['submit'])){
		...
		$query1 = "UPDATE zonelofficestaff SET staffName = '".$name."' , address = '".$address."', email = '".$email."', telNo = '".$telephone."' WHERE id='".$userid."'";
