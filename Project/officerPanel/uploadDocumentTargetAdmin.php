...
// Check if $uploadOk is set to 0 by an error
        if ($uploadOk == 0) {
            ...
            echo "<a href='uploadDocument.php'class='btn btn-info'>Try again</a>";
// if everything is ok, try to upload file
        } else {
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                echo " <br><br><br><br><br>" . basename($_FILES["fileToUpload"]["name"]) . " <h3 class='text text-success'> has been successfully uploaded.</h3>";
				
                $query ="INSERT INTO adminuploadeddocuments (name) VALUES('".$Filename."')";
