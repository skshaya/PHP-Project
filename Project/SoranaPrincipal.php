      ...
      <div id="container">
                <div id="division" class="col-lg-10 panel panel-muted "> 
                    <div class="panel-heading bg-primary"> 
                        ...
                        <h2 class="title" style="font-family: AR JULIAN; font-color:white" ><strong>SORANATHOTA DEVISION</strong> -PRINCIPAL DETAILS</h2> 
                    </div> 
...
//include('db.php');
                                $sql = "SELECT * FROM principal where division='Soranathota'";
