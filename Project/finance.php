...
<html>
    ...
    <body>
        <div id="container">
            ...
            <div class="row" style="border-bottom: 2px solid #094499">
                <h1 class="text text-primary text-center">Our Financial Team</h1>
            </div>
            <div class="row">
                <div class="col-lg3 col-md-3" style="margin-top: 10px">
                    <div  style="border-bottom: 2px solid #094499">
